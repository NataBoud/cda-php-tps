{{-- Layout de base pour l'ensemble de l'application --}}
...
<head>
    ...
    {{-- Définition du titre de la page qui pourra être modifié sur chaque page à l'aide de la variable title --}}
    <title>{{ config('app.name', 'Laravel') }} - @yield('title')</title>
    <meta name="csrf-token" content="{{ csrf_token() }}">

    {{-- Permet de générer automatiquement les balises pour le css et le js compilé dynamiquement --}}
...
<body>
    ...
    <main>
        ...
        {{-- Element qui sera remplacé par le contenu de la page --}}
        @yield('content')
    </main>
</body>
